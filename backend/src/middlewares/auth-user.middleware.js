...
const authUser = (type = "access", role) => (req, res, next) => {
    const authorizationHeader = req.headers.authorization;
    if (!authorizationHeader) {
        throw new ResponseError(403, "Auth Error", "Unauthorized - No token");
    }
    ...
    try {
        ...
        throw new ResponseError(403, "Auth Error", "Unable to verify token");
    }
